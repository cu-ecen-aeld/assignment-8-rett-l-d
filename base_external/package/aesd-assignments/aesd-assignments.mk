...
AESD_ASSIGNMENTS_VERSION = dde7239803ac44a00d13cf365ff02b9165f6a7b3
...
define AESD_ASSIGNMENTS_BUILD_CMDS
	...
	$(MAKE) -C $(@D)/aesd-char-driver clean
endef

# Specify that the kernel source is in a subdirectory relative to the top of the repo
AESD_ASSIGNMENTS_MODULE_SUBDIRS = aesd-char-driver

# Ensure the Linux kernel headers are built before trying to build this module
...
# Evaluate the char driver as a kernel module
$(eval $(kernel-module))